...
<body style="margin: 0; padding: 0; background-color: #030508; background-image: linear-gradient(#030508, #030508); color: #ffffff !important; -webkit-text-fill-color: #ffffff !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;">
...
We appreciate your interest and support.
      ...
      <div class="footer" style="text-align: center; padding-top: 30px;">
        <div class="footer-text" style="font-size: 11px; color: #808080 !important; -webkit-text-fill-color: #808080 !important; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 12px;">
          © ${new Date().getFullYear()} WEBIS. ALL RIGHTS RESERVED.
        </div>
        <div class="social-links" style="margin-top: 24px;">
          <a href="#" class="social-link" style="color: #b3b3b3 !important; -webkit-text-fill-color: #b3b3b3 !important; text-decoration: none; font-size: 12px; margin: 0 12px; letter-spacing: 0.05em;">WEBSITE</a>
          <a href="#" class="social-link" style="color: #b3b3b3 !important; -webkit-text-fill-color: #b3b3b3 !important; text-decoration: none; font-size: 12px; margin: 0 12px; letter-spacing: 0.05em;">INSTAGRAM</a>
          <a href="#" class="social-link" style="color: #b3b3b3 !important; -webkit-text-fill-color: #b3b3b3 !important; text-decoration: none; font-size: 12px; margin: 0 12px; letter-spacing: 0.05em;">TWITTER</a>
        </div>
        <div class="unsub" style="margin-top: 30px; font-size: 11px; color: #4d4d4d !important; -webkit-text-fill-color: #4d4d4d !important;">
